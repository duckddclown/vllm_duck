...
class LLM:
    ...
    def _run_engine(self, use_tqdm: bool) -> List[RequestOutput]:
        ...
        print(self.llm_engine.scheduler.block_manager.total_seq)
        print(self.llm_engine.scheduler.block_manager.hit)
        print(self.llm_engine.scheduler.block_manager.hit / self.llm_engine.scheduler.block_manager.total_seq)
        return outputs
